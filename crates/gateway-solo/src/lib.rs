//! Gateway SOLO — single-tenant, standalone gateway binary.
//!
//! Re-usable library surface shared by the `gateway-solo` and `opencook` binaries.
...
pub async fn run_config_wizard() -> anyhow::Result<()> {
